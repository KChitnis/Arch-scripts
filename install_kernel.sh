...
echo ALL_KVER='"'/boot/vmlinux-$kernel'"' >> /etc/mkinitcpio.d/$kernel.preset
echo "PRESETS=('"'defaults'"' '"'fallback'"')" >> /etc/mkinitcpio.d/$kernel.preset
...
echo fallback_option='"'-S autodetect'"' >> /etc/mkinitcpio.d/$kernel.preset
